...
const conversion = {
  ...
  pc: {
    ...
    ch: (value, props) => (value * 96) / 12 / props.chFontSize,
  ...
  ch: {
    ...
    vw: (value, props) => (value * props.chFontSize) / props.viewPortWidth,
    vh: (value, props) => (value * props.chFontSize) / props.viewPortHeight,
    vmin: (value, props) => (value * props.chFontSize) / props.minViewPortSize,
    vmax: (value, props) => (value * props.chFontSize) / props.maxViewPortSize,
    in: (value, props) => (value * props.chFontSize) / 96,
    pc: (value, props) => (value * props.chFontSize) / 12,
    pt: (value, props) => (value * props.chFontSize) / 72,
    cm: (value, props) => (value * props.chFontSize) / 2.54,
    mm: (value, props) => (value * props.chFontSize) / 25.4,
    q: (value, props) => (value * props.chFontSize * 4) / 25.4,
  },
  cm: {
  ...
  q: {
    ...
    ch: (value, props) => ((value / 4) * 96) / 25.4 / props.chFontSize,
  ...
  vw: {
    ...
    ch: (value, props) => ((value / 100) * props.viewPortWidth) / props.chFontSize,
  ...
  vh: {
    ...
    ch: (value, props) => ((value / 100) * props.viewPortHeight) / props.chFontSize,
